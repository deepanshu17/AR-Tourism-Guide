...
public class Explore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CityAdapter(this, albumList);
    ...
    private void prepareAlbums() {
        ...
        City a = new City("Jaipur", 20, covers[0]);
        albumList.add(a);

        a = new City("Kota", 13, covers[1]);
        albumList.add(a);

        a = new City("Udaipur", 11, covers[2]);
        albumList.add(a);

        a = new City("Jodhpur", 17, covers[3]);
        albumList.add(a);

        a = new City("Bikaner", 14, covers[4]);
        albumList.add(a);

        a = new City("Shekhawati", 10, covers[5]);
        albumList.add(a);

        a = new City("Bundi", 14, covers[4]);
        albumList.add(a);

        a = new City("chittorgarh", 10, covers[5]);
        albumList.add(a);
